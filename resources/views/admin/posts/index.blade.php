    ...
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex-shrink-0 flex items-center">
          <h1 class=" text-white px-3 py-2 rounded-md text-sm font-medium">HelpDesk</h1>
        </div>
        <div class="hidden sm:block sm:ml-6">
          <div class="flex space-x-4">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="{{route('posts.create')}}" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">Criar Novo Post</a>
                    ...
                    <form action="{{route('posts.search')}}" method="post">
                        ...
                        <button class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" type="submit">Buscar</button>
                    </form>
